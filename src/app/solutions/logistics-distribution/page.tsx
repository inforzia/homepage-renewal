        ...
        <main className={styles.page}>
            ...
            <ScrollLinkedSteps
                ...
                items={workflow.map((item, index) => ({
                    ...
                    image: [
                        "/_assets/v11/5a2dd641e649701d91d1b18075e60d73d5167978.png",
                        "/_assets/v11/469b06db7d595047c1aad4590f3ebcc1778d0211.png",
                        "/_assets/v11/e92b47d1b45068361c9c20c41e1f28127bc9db0c.png",
                    ].map(asset)[index],
                    label: item.list,
